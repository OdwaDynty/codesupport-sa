...
export default function RequestStatusPage() {
  ...
  const checkRequest = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        setErrorMessage(
          data.error || "Request could not be found."
        );
        return;
      }
      ...
      <div className="mx-auto max-w-3xl">
        <div className="mb-8">
          <h1 className="text-3xl font-bold">
            Check My Coding Request
          </h1>

          <p className="mt-2 text-slate-400">
            Enter your request reference to check the status of
            your coding help request.
          </p>
        </div>
            ...
            <div className="rounded-xl border border-slate-700 bg-slate-900 p-6">
              ...
              {request.admin_response ? (
                ...
                <div className="mt-4 rounded-lg border border-slate-700 bg-slate-950 p-4 text-slate-400">
                  Your request is still being reviewed. A
                  response will appear here once it has been
                  answered.
                </div>
              )}
            </div>
