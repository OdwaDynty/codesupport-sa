...
const topics = [
  {
    ...
    description: "What TypeScript is, and why adding types to JavaScript helps.",
    level: "Beginner",
    available: true,
  },
  {
  ...
  },
  {
    ...
    description: "Add types to function parameters and return values.",
    level: "Beginner",
    available: true,
  },
  {
    ...
    description: "Type arrays of values and the shape of objects.",
    level: "Beginner",
    available: true,
  },
  {
    ...
    slug: "interfaces",
    title: "Interfaces",
    description: "Define reusable shapes for objects using interfaces.",
    level: "Intermediate",
    available: true,
  },
  {
    number: "06",
    slug: "union-types",
    title: "Union Types & Type Aliases",
    description: "Allow a value to be one of several types, and name your own types.",
    level: "Intermediate",
    available: true,
  },
  {
    ...
    slug: "classes",
    title: "Classes",
    description: "Build classes with typed properties and methods.",
    level: "Intermediate",
    available: true,
  },
  {
    ...
    description: "Mark properties as optional or unchangeable.",
    level: "Intermediate",
    available: true,
  },
  {
    ...
    slug: "enums",
    title: "Enums",
    description: "Define a fixed set of named values.",
    level: "Intermediate",
    available: true,
  },
  {
    ...
    description: "Write reusable code that works with more than one type.",
    level: "Intermediate",
    available: true,
  },
];
...
export default function TypeScriptPage() {
  ...
  useEffect(() => {
    getCompletedTopics("typescript").then(setCompletedSlugs);
  }, []);
          ...
          <div className="mt-10 flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
            <div className="max-w-3xl">
              ...
              <p className="mt-6 text-lg leading-8 text-slate-400">
                Learn how adding types to your code helps catch mistakes
                before you even run your program.
              </p>
            </div>
      ...
      <section className="mx-auto max-w-5xl px-6 py-16 lg:px-8">
        <div className="mb-8">
          ...
          <p className="mt-2 text-slate-400">
            Some basic JavaScript knowledge helps, but isn't required to
            get started.
          </p>
        </div>
        ...
        <div className="space-y-4">
          {topics.map((topic) => (
            <Link
              key={topic.number}
              href={topic.available ? `/learn/typescript/${topic.slug}` : "#"}
