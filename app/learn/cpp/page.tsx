...
const topics = [
  {
    ...
    description: "What C++ is, and how it compares to the other languages you may already know.",
    level: "Beginner",
    available: true,
  },
  {
...
export default function CppPage() {
  ...
  useEffect(() => {
    getCompletedTopics("cpp").then(setCompletedSlugs);
  }, []);
          ...
          <div className="mt-10 flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
            <div className="max-w-3xl">
              ...
              <p className="mt-6 text-lg leading-8 text-slate-400">
                Strengthen your programming logic and learn the
                fundamentals of C++, including memory and pointers.
              </p>
            </div>
      ...
      <section className="mx-auto max-w-5xl px-6 py-16 lg:px-8">
        <div className="mb-8">
          ...
          <p className="mt-2 text-slate-400">
            Start at the beginning if C++ is new to you.
          </p>
        </div>
        ...
        <div className="space-y-4">
          {topics.map((topic) => (
            <Link
              key={topic.number}
              href={topic.available ? `/learn/cpp/${topic.slug}` : "#"}
